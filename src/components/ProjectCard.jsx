...
const ProjectCard = ({name, category, image, link}) => {
  return (
    <Link to={link} className='flex flex-col sm:flex-row items-start justify-between lg:gap-4 2xl:gap-8 lg:justify-evenly'>
        ...
        <img src={image} alt="" srcSet="" className='rounded w-[280px] h-[250px] sm:h-[225px] lg:h-[180px] xl:h-[225px] object-cover'/>
    </Link>
  )
}
